  ...
  return (
    <form action={dispatch}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        {/* customer name */}
        <div className="mb-4">
          <label htmlFor="customer-name" className="mb-2 block text-sm font-medium">Choose a name</label>
        ...
        {/* customer email */}
        <div className="mb-4">
          <label htmlFor="customer-email" className="mb-2 block text-sm font-medium">Choose a email</label>
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                id="email"
